...
\input{missing-vachist/missing-vachist.tex}
...
\input{table-bleed-counts/bleed-counts-Vaccination.tex}
\input{table-bleed-counts/bleed-counts-Infection.tex}
...
\input{table-bleed-counts/routine-bleed-counts-covid.tex}

\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figure-bleed-dates/figure-covid-bleed-dates.pdf}
	\caption{Covid vaccination dates and post-vaccination bleed dates.}
	\label{fig:covid-vax-bleed-dates}
\end{figure}

\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figure-titre/covid-vax-titres.pdf}
...
\begin{figure}
	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figure-titre/covid-adeno-corr.pdf}
